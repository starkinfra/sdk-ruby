...
module StarkInfra
  class IssuingEmbossingRequest
    ...
    #
    # Every time an IssuingEmbossingRequest entity is updated, a corresponding issuing request.Log is generated for the entity. This log
    ...
    class Log < StarkInfra::Utils::Resource
      ...
      def initialize(id:, request:,errors:,type:, created:)
        super(id)
        @request = request
        @type = type
        @errors = errors
