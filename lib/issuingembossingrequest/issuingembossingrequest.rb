...
module StarkInfra
  ...
  class IssuingEmbossingRequest < StarkInfra::Utils::Resource
    attr_reader :card_id, :card_design_id, :envelope_design_id, :display_name_1, 
                :shipping_city, :shipping_country_code, :shipping_district, :shipping_state_code, 
                :shipping_street_line_1, :shipping_street_line_2, :shipping_service, 
                :shipping_tracking_number, :shipping_zip_code, :embosser_id, :display_name_2, 
                :display_name_3, :shipping_phone, :tags, :id, :fee, :status, :created, 
                :updated
    def initialize(
      card_id:, card_design_id:, envelope_design_id:, display_name_1:, shipping_city:, 
      ...
      @envelope_design_id = envelope_design_id
    ...
    def self.create(requests:, expand: nil, user: nil)
      StarkInfra::Utils::Rest.post(entities: requests, expand: expand, user: user, **resource)
    end
    ...
    #
    # Receive a list of IssuingEmbossingRequests objects previously created in the Stark Infra API and the cursor to the next page.
    #
    # ## Parameters (optional):
    ...
    def self.resource
      {
        ...
        resource_maker: proc { |json|
          IssuingEmbossingRequest.new(
            ...
            card_design_id: json['card_design_id'],
            envelope_design_id: json['envelope_design_id'],
