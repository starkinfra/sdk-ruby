...
module StarkInfra
  class IssuingStock
    ...
    #
    # Every time an IssuingStock entity is updated, a corresponding issuing stock.Log is generated for the entity. This log
    ...
    # - type [string]: type of the IssuingStock event which triggered the log creation. ex: 'processing' or 'success'
    # - created [DateTime]: creation datetime for the log. ex: DateTime.new(2020, 3, 10, 10, 30, 0, 0)
    class Log < StarkInfra::Utils::Resource
      attr_reader :id, :stock, :type, :created
      def initialize(id:, stock:, type:, created:)
        super(id)
        @stock = stock,
        @type = type,
      ...
      def self.page(cursor: nil, limit: nil, after: nil, before: nil, types: nil, stock_ids: nil, ids: nil, user: nil)
        after = StarkInfra::Utils::Checks.check_date(after)
        before = StarkInfra::Utils::Checks.check_date(before)
