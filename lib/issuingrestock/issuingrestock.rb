...
module StarkInfra
  ...
  class IssuingRestock < StarkInfra::Utils::Resource
    ...
    #
    # Receive a generator of IssuingRestocks objects previously created in the Stark Infra API
    #
    # ## Parameters (optional):
    ...
    #
    # Receive a list of IssuingRestocks objects previously created in the Stark Infra API and the cursor to the next page.
    #
    # ## Parameters (optional):
