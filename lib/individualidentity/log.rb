...
module StarkInfra
  class IndividualIdentity
    ...
    #
    # Every time an IndividualIdentity entity is updated, a corresponding IssuingInvoice::Log is generated for the entity.
    ...
    # - type [string]: type of the IndividualIdentity event which triggered the log creation. ex: 'approved', 'canceled', 'confirmed', 'denied', 'reversed', 'voided'.
    ...
    class Log < StarkInfra::Utils::Resource
      ...
      #
      # ## Parameters (optional):
      # - ids [list of strings, default nil]: list of IndividualIdentity ids to filter logs. ex: ['5656565656565656', '4545454545454545']
