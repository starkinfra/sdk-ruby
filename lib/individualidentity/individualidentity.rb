...
module StarkInfra
  ...
  class IndividualIdentity < StarkInfra::Utils::Resource
    ...
    #
    # Receive a single IndividualIdentity object previously created in the Stark Infra API by its uuid
    #
    # ## Parameters (required):
    ...
    # # Retrieve IndividualIdentities
    #
    # Receive a list of IndividualIdentity objects previously created in the Stark Infra API and the cursor to the next page.
    #
    # ## Parameters (optional):
