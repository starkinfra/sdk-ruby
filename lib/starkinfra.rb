...
require_relative('credit_holmes/log')
...
require_relative('issuing_token/log')
require_relative('issuing_token_activation/issuing_token_activation')
...
require_relative('ledger/log')
require_relative('ledger_transaction/ledger_transaction')
...
require_relative('pix_user/pix_user')
require_relative('pix_user/statistics')
